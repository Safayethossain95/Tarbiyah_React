...
const DonationMb = () => {
  return (
    <>
        <div className="donationmb" data-aos-delay="400" data-aos="fade-up" data-aos-duration="2000">
            <div className="mycontainermb">
                <h4 className='subheading'>Care for a donation!</h4>

                <div className="picframe ms-auto">
                        <img className='w-100' src="./assets/images/Mobile/HomepageMb/donation/donationmb.png" alt="" />
                </div>
