...
const AboutTarbiyah = () => {
  ...
  return (
    <>
        <div className="abouttarbiyahsection" data-aos-delay="400" data-aos="fade-up" data-aos-duration="2000">
