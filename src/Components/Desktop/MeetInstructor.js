...
const MeetInstructor = () => {
  ...
  return (
    <>
        <div className=" meetinstructosection">
                <div className={screenSize.dynamicWidth>=1200 &&screenSize.dynamicWidth <=1399?"myContainerMinimini":screenSize.dynamicWidth>=992 &&screenSize.dynamicWidth<=1199?"myContainer896":"myContainerMini"}>
                    <Row className='align-items-center'>
                        <Col lg={6} data-aos-delay="400" data-aos="fade-right" data-aos-duration="1800" style={{paddingLeft:"35px"}}>                        
                            <MediumHeading text="Meet Our Instructor!"/>
                        ...
                        <Col lg={6} data-aos-delay="400" data-aos="fade-left" data-aos-duration="1800">                        
                            <div className="img">
                                <img src="./assets/images/Homepage/meetinstructor/meetins.png" alt="" />
                            </div>
                        </Col>
                    </Row>
